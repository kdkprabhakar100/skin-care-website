function Hero() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-10 py-16 bg-[#F8F6F4]">

      <div className="max-w-lg">
        <h1 className="text-5xl font-bold text-[#6D1F2F]">
          Glow Naturally ✨
        </h1>
      ...
      <img
        ...
        className="w-80 mt-8 md:mt-0 rounded-xl shadow-lg"
      />
